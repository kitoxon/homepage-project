...
export default function GradientText({ text }: GradientTextProps) {
  ...
  return (
    <div className="mb-[10px] text-left">
      ...
      >
        <div className="flex flex-col transform skew-x-0 -skew-y-[8deg]">
          {!showInnerDiv && (
            <p
              className="text-[80px] font-semibold leading-none text-transparent min-h-24 max-w-full font-poppins transform skew-x-0 skew-y-0"
              style={{
          ...
          <div className="mt-[-95px] flex relative content-center items-center flex-none flex-row h-20 bg-[rgba(0, 0, 0, 0, 0)] flex-nowrap max-w-full skew-0">
            <AnimatePresence>
              {showInnerDiv && (
                <motion.div
                  key="inner-div"
